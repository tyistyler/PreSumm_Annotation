...
def build_trainer(args, device_id, model, optims, loss):
    ...
    # grad_accum_count=5
    # print("grad_accum_count={}".format(grad_accum_count))
...
class Trainer(object):
    ...
    def validate(self, valid_iter, step=0):
        ...
        with torch.no_grad():
            for batch in valid_iter:
                ...
                outputs, _ = self.model(src, tgt, segs, clss, mask_src, mask_tgt, mask_cls)     # [4, 28, 768]
    ...
    def _gradient_accumulation(self, true_batchs, normalization, total_stats,
        ...
        # print("true_batchs: {}".format(len(true_batchs)))
        for batch in true_batchs:
            ...
            mask_tgt = batch.mask_tgt
            mask_cls = batch.mask_cls
            # print("src:{}".format(src.size()))           # [1, 512]
            # print("tgt:{}".format(tgt.size()))           # [1, 79]
            # print("segs:{}".format(segs.size()))          # [1, 512] -->使用0、1来分割句子
            # print("clss:{}".format(clss.size()))          # [1, 22] -->每个句子cls对应的位置 
            # print("mask_src:{}".format(mask_src.size()))      # [1, 512]
            # print("mask_tgt:{}".format(mask_tgt.size()))      # [1, 79]
            # print("mask_cls:{}".format(mask_cls.size()))      # [1, 22]
            outputs, scores = self.model(src, tgt, segs, clss, mask_src, mask_tgt, mask_cls)
            # print("outputs:{}".format(outputs.size()))            # [1, 78, 768]
            # print("shard_size={}".format(self.args.generator_shard_size)) # 32
            # 计算损失
